...
\begin{figure}
	\centering
       {\subfloat[Methane Gas test.]{\includegraphics[width=0.4\textwidth]{./matlab/MethaneTest1.eps}\label{fig:methanetest}}
	\hfil
	\subfloat[Liquefied Petroleum Gas test.]{\includegraphics[width=0.4\textwidth]{./matlab/LPG.eps}\label{fig:lpg}}
	\hfil
	\subfloat[Carbon Monoxide test.]{\includegraphics[width=0.4\textwidth]{./matlab/COTest1.eps}\label{fig:co}}
	\hfil
	\subfloat[Hydrogen test.]{\includegraphics[width=0.4\textwidth]{./matlab/HydrogenTest1.eps}\label{fig:hydrogen}}}
