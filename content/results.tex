...
\begin{figure}
	\centering
	\includegraphics[width=0.4\textwidth]{./matlab/MethaneToxic.png}
...
\begin{figure}
	\centering
       {\subfloat[Methane Gas test.]{\includegraphics[width=0.4\textwidth]{./matlab/MethaneTest1.png}\label{fig:methanetest}}
	\hfil
	\subfloat[Liquefied Petroleum Gas test.]{\includegraphics[width=0.4\textwidth]{./matlab/LPG.png}\label{fig:lpg}}
	\hfil
	\subfloat[Carbon Monoxide test.]{\includegraphics[width=0.4\textwidth]{./matlab/COTest1.png}\label{fig:co}}
	\hfil
	\subfloat[Hydrogen test.]{\includegraphics[width=0.4\textwidth]{./matlab/HydrogenTest1.png}\label{fig:hydrogen}}}
	\caption{Gas concentration tests.}
	\label{fig:gas-tests}
\end{figure}

%\begin{figure}
%	\centering
%	\includegraphics[width=0.38\textwidth]{./matlab/MethaneTest1.eps}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=0.38\textwidth]{./matlab/LPG.eps}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=0.38\textwidth]{./matlab/COTest1.eps}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=0.38\textwidth]{./matlab/HydrogenTest1.eps}
